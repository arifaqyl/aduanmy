...
TRANSPORT_STRONG_INCIDENT_TERMS = [
    ...
    # News-register incident vocabulary. Added 2026-09-01 after finding that
    # "Train derails on Ampang-Sri Petaling line" scored zero incident terms —
    # a derailment did not register as an incident. Reporters do not write
    # "tak gerak"; they write "derailed", "fault", "evacuated".
    "derail",
    "derailed",
    "derailment",
    "tergelincir",
