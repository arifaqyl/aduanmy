const CACHE = 'trafficmy-shell-v29';
...
const shell = [
  ...
  `${base}/static/css/components.css?v=29`,
  `${base}/static/css/play.css?v=29`,
  `${base}/static/css/stitch.css?v=29`,
  `${base}/static/lines/kv-system.svg`,
  `${base}/static/js/app.js?v=29`,
