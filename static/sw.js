const CACHE = 'trafficmy-shell-v30';
...
const shell = [
  ...
  `${base}/static/css/components.css?v=30`,
  `${base}/static/css/play.css?v=30`,
  `${base}/static/css/stitch.css?v=30`,
  `${base}/static/lines/kv-system.svg`,
  `${base}/static/js/app.js?v=30`,
];
