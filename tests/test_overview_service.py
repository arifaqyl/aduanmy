...
def _days_ago_iso(days: int, hours: int = 0, minutes: int = 0) -> str:
    return (myt_day_start() - timedelta(days=days) + timedelta(hours=hours, minutes=minutes)).isoformat().replace("+00:00", "Z")
    ...
    upsert_complaints(
        [
            ...
            ComplaintSchema(
                ...
                author_handle="askrapidkl",
                created_at=_days_ago_iso(40, 11, 50),
